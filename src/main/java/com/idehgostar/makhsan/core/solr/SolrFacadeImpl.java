...
//    }
    ...
    /**
     * first creates a string query by concating elements with 'AND' operator and then calls {@link #search(String, int, int, com.idehgostar.makhsan.core.solr.HighlightOptions, String, int, java.util.Set)}
     *
     * @param queryElements
     * @param start
     * @param count
