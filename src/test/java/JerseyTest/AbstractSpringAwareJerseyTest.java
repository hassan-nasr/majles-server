	...
	public AppDescriptor configure() {
		...
		WebAppDescriptor wa = new WebAppDescriptor.Builder()
				...
				.contextParam("contextConfigLocation",
                        "classpath:applicationContext-makhsan-resource-test.xml " +
                                "classpath:applicationContext-makhsan-persistence.xml " +
								"classpath:applicationContext-makhsan-security.xml " +
								"classpath:applicationContext-makhsan-service.xml " +
								"classpath:applicationContext-makhsan.xml "
